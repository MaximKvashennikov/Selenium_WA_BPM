...
class GetReport:
    ...
    def click_diskette(self):
        self.driver.switch_to.frame(
            self.driver.find_element_by_xpath('//*[@id="main"]/div/paginated-report-viewer/div/iframe'))
        self.driver.find_element_by_xpath('//*[@id="ReportViewerControl_ctl05_ctl04_ctl00_ButtonImgDown"]').click()
        self.driver.find_element_by_xpath('//*[@id="ReportViewerControl_ctl05_ctl04_ctl00_Menu"]/div[2]/a').click()
        time.sleep(12)
